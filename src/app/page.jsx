...
export default function Home() {
  ...
  return (
    <div className="">
      ...
      <dialog id="dialog" className="border-4 p-6 text-center rounded-lg shadow-lg z-20 fixed top-[35%]">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 justify-center items-center gap-5 p-10">
        {heroData.map((hero) => (
          <div onClick={() => handleClick(hero.id)} className="p-3 flex flex-col items-center bg-[#ffffff] rounded-lg shadow-lg duration-200 cursor-pointer hover:scale-105" key={hero.id}>
            <h2 className="text-3xl w-full text-start font-bold text-[#000000]">{hero.heroName}</h2>
